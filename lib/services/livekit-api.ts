 ...
 * The room name is generated by the backend. The region is handled by the backend.
 * The identity is generated by the backend.
 * @returns An object containing the token, LiveKit server URL (livekitUrl), roomName, identity, and region (as returned by backend).
 */
export async function getLiveKitToken() {
  ...
  try {
    ...
    logger.success(`Successfully obtained LiveKit token from backend`, { tokenLength: token.length, livekitUrl, roomName, identity, region });
    return { token, livekitUrl, roomName, identity, region };
  } catch (error) {
